...
def main(machine_id=0, worker_id=0, batch_size=32, debug=0):
    ...
    job_num = -1  # will be immediately incremented
    ...
    for model_size in MODEL_SIZES:
        ...
        for revision in revs:
            ...
            model, device = setup_model(model_name, revision, worker_id)
...
# Somewhat hacky way to make sure you dont remove a model while someone is downloading it
# things happen on the order of minutes, so clashes are possible but unlikely
def lock(i):
